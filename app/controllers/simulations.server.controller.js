...
exports.delete = function (req, res) {
    ...
    simulation.remove(function (err) {
        if (err) {
            ...
            res.json(simulation);
            rmdir('./run/simulations/' + simulation.id.toString(), function (err) {
                if (!err) {
...
var querySimulations = function (req, res) {
    var search = _.extend({'user': req.user.id}, req.query);
    Simulation.find(search)
        .sort('-created')
        .populate('user', 'displayName')
        .populate('model', 'name')
        .exec(function (error, simulations) {
            if (error) {
...
var groupUserSimulations= function(req, res){
...
exports.list = function (req, res) {
    if (_.isEmpty(req.query)){
        groupUserSimulations(req, res);
    } else {
        querySimulations(req, res);
    }
};
